...
import 'package:bloodlink_app/screens/onboard/onboarding_content.dart';
  ...
  AnimatedContainer _buildDots({
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
          ...
          color: _currentPage == index ? primaryColor : secondprimaryColor2
          //  Color(0xFF000000),
          ),
                          ...
                          child: Row(
                            ...
                            children: [
                              TextButton(
                                ...
                                child: const Text(
                                  "SKIP",
                                  style: TextStyle(color: secondprimaryColor2),
                                ),
                              ),
                              ElevatedButton(
                                onPressed: () {
